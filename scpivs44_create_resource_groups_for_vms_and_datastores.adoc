...
NOTE: El sistema de almacenamiento ASA R2 no admite el cambio de nombre de Snapshots y, como resultado, no se admiten las funciones de nomenclatura de SCV backup y _recent Snapshot.
