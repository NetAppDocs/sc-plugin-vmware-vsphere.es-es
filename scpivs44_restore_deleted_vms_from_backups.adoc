...
.Pasos
. Seleccione *Menú* y seleccione la opción de menú *Almacenamiento*, luego seleccione un almacén de datos, luego seleccione la pestaña *Configurar* y luego seleccione *Copias de seguridad* en la sección *SnapCenter Plug-in for VMware vSphere*.
