...
.Pasos
. En el panel de navegación de la izquierda del plugin de SCV, haga clic en *Resource Groups*, después seleccione un grupo de recursos y, a continuación, seleccione image:scpivs44_image38.png["Icono Reproducir"] *Ejecutar ahora* para iniciar la copia de seguridad.
