...
summary:  
---
= Crea grupos de recursos en el SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. En el panel de navegación izquierdo del plugin SCV, seleccione *Grupos de recursos* y luego seleccione *Crear*.
