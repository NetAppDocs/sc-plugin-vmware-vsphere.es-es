...
---
= Flujo de trabajo de protección de datos para el SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Mejora la protección de VMware usando NetApp Backup and Recovery, que ofrece backup 3-2-1, protección contra ransomware, gestión automatizada de backup, mayor escalabilidad, reducción de costes y gestión centralizada de varias instancias de vCenter. Puedes migrar políticas, snapshots y programaciones de SCV a NetApp Backup and Recovery y gestionar toda la protección de VM desde una sola consola. Para más información, consulta link:https://docs.netapp.com/us-en/data-services-backup-recovery/["NetApp Backup and Recovery documentación"].
...
En las configuraciones de NetApp MetroCluster:
