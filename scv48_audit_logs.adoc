...
| ELIMINACIÓN DINÁMICA | * El archivo de registro de auditoría se elimina según la retención * de forma predeterminada, sólo se conservan 10 archivos 


| ELIMINACIÓN INESPERADA | Se elimina el archivo de registro de auditoría 


| ACTIVO | * El archivo de registro de auditoría está en uso * sólo aplicable a audit.log 
|===
