...
---
= Agrega una sola máquina virtual o datastore a un grupo de recursos en el SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Pasos
. En la interfaz de usuario del cliente vSphere, seleccione *Menú* en la barra de herramientas y navegue hasta la máquina virtual o el almacén de datos que desea agregar.
